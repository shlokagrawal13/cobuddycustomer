...
const BENEFITS = [
  {icon: 'support-agent', title: 'Concierge Alerts',         sub: 'Instant updates from your personal concierge team'},
  {icon: 'event',         title: 'Session Reminders',         sub: 'Never miss a booking or pre-session briefing'},
  {icon: 'security',      title: 'Safety Pings',              sub: 'Emergency alerts and safety check-ins during sessions'},
];
  ...
  return (
    <SafeAreaView style={styles.root} edges={['top', 'bottom']}>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('BasicProfileSetup' as any)}
        activeOpacity={0.7}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.iconHeroWrap}>
          ...
          <View style={styles.iconCircle}>
            <Icon name="notifications" size={44} color={Colors.primary} />
          </View>
        ...
        <View style={styles.textBlock}>
          ...
          <Text style={styles.subtitle}>
            Receive real-time updates from your concierge, session alerts, and safety check-ins — all discreetly managed.
          </Text>
        </View>
        ...
        <View style={styles.privacyRow}>
          ...
          <Text style={styles.privacyText}>
            Notifications are discreet and never contain personally identifying information. You control all preferences.
          </Text>
        </View>
      </View>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              ...
              [{text: 'Continue', onPress: () => navigation.navigate('BasicProfileSetup' as any)}, {text: 'Cancel', style: 'cancel'}],
            )
          }
          activeOpacity={0.88}>
          <Icon name="notifications-active" size={18} color={Colors.onPrimary} />
          <Text style={styles.ctaPrimaryText}>Enable Notifications</Text>
        </TouchableOpacity>
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  content: {
    ...
    paddingHorizontal: 24, paddingTop: 16, gap: 28,
  },
  // Icon hero
  ...
  notifDot: {width: 6, height: 6, borderRadius: 3, backgroundColor: Colors.primary},
  notifChipText: {fontFamily: 'Inter-SemiBold', fontSize: 10, color: Colors.primary},
  // Text
  ...
  // Privacy
  privacyRow: {flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 8},
  privacyText: {
